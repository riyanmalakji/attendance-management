...
public class MainActivity extends AppCompatActivity {
    ...
    private String[] studentNames = {"Riyan", "Shafe", "Amaan", "Shoeb", "Ganesh", "Krishna", "Aditya", "Gaurav", "Swapnil", "Om", "Rohan", "Shaurya"};
    ...
    private void saveDataToFirebase() {
        ...
        attendanceMap.put("DateTime  "  + "6th Semester", dateTime);
